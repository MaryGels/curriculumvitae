var initDot = document.getElementById("loading");
   ...
   var initProgram = setTimeout(function(){
       var greeting = "DETECTADA FORMA DE VIDA ORGANICA SIN IDENTIFICAR";
       var message = "RUNNING CODEPEN CURRICULUM VITAE PROTOCAL (CRP) FOR @MARYGELS";
       var $identityDiv = $("#identity-results");
       var $name = "NAME: M ANGELES MORCILLO GONZALEZ";
       var $alias = "KNOWN ALIAS: MARYGELS"
       ...
       var $frontEnd  = "FRONT END DEVELOPMENT CORE: HTML5 | CSS3 | JAVASCRIPT";
         ...
         var $CSSFrameworks = "CSS FRAMEWORKS: BOOTSTRAP | AOS";
         var $CSSPre = "CSS PREPROCESSORS: SASS | LESS | STYLUS";
         var $frontEndAnimation = "FRONT END ANIMATION: HTML5 | CSS3 | SVG";
       ...
       var $design = "DESIGN CORE: ADOBE SUITE";
         var $webDesign = "WEB DESIGN: INDESIGN CC";
         var $branding = "ILLUSTRATIONS & BRANDING: PHOTOSHOP CC";
